(ns day8.re-frame-10x.inlined-deps.re-com.v2v5v0.re-com.box
  (:require [clojure.string  :as    string]
            [day8.re-frame-10x.inlined-deps.re-com.v2v5v0.re-com.validate :refer [justify-style? justify-options-list align-style? align-options-list scroll-style?
...
(defn h-box
  ...
  (let [s        (merge
                   ...
                   style)
        gap-form (when gap [day8.re-frame-10x.inlined-deps.re-com.v2v5v0.re-com.box/gap
                            :size  gap
