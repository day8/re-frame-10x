(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.reagent.v1v0v0.reagent.impl.template
  (:require [react :as react]
            [clojure.string :as string]
            [day8.re-frame-10x.inlined-deps.reagent.v1v0v0.reagent.impl.util :as util :refer [named?]]
            ...
            [day8.re-frame-10x.inlined-deps.reagent.v1v0v0.reagent.debug :refer-macros [dev? warn]]
            [goog.object :as gobj]))
