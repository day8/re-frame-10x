(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.impl.template
  (:require [react :as react]
            [clojure.string :as string]
            [clojure.walk :refer [prewalk]]
            [day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.impl.util :as util :refer [is-client named?]]
            [day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.impl.component :as comp]
            ...
            [day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.debug :refer-macros [dbg prn println log dev?
                                                                                        warn warn-unless]]
            [goog.object :as gobj]))
