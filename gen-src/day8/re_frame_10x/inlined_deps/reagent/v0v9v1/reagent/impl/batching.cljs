(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.impl.batching
  (:refer-clojure :exclude [flush])
  (:require [day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.debug :refer-macros [assert-some]]
            [day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.impl.util :refer [is-client]]))
