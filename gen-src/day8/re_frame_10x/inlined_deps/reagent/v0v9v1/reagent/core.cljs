(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.core
  ...
  (:require [react :as react]
            [day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.impl.template :as tmpl]
            ...
            [day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.debug :as deb :refer-macros [dbg prn
                                                                                                assert-some assert-component
                                                                                                assert-js-object assert-new-state
                                                                                                assert-callable]]
            [day8.re-frame-10x.inlined-deps.reagent.v0v9v1.reagent.dom :as dom]))
