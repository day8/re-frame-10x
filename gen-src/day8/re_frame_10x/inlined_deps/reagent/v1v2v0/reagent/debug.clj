(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug
...
(defmacro log
  ...
  [& forms]
  `(when day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug.has-console
...
(defmacro warn
  ...
  (when *assert*
    `(when day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug.has-console
       (.warn (if day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug.tracking
                day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug.track-console
                js/console)
              (str "Warning: " ~@forms)))))
...
(defmacro error
  ...
  (when *assert*
    `(when day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug.has-console
       (.error (if day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug.tracking
                 day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug.track-console
                 js/console)
               (str ~@forms)))))
