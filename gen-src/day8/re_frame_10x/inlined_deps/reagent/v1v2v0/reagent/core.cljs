(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.core
  (:require-macros [day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.core])
  (:refer-clojure :exclude [partial atom flush])
  (:require [react :as react]
            [day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template :as tmpl]
            [day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.component :as comp]
            ...
            [day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.debug :as deb :refer-macros [assert-some assert-component
...
(defn render
  ...
  [& _]
  (throw (js/Error. "Reagent.core/render function was moved to day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.dom namespace in Reagent v1.0.")))
