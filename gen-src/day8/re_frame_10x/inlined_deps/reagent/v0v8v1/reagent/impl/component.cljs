(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.reagent.v0v8v1.reagent.impl.component
  (:require [create-react-class :as create-react-class]
            ...
            [day8.re-frame-10x.inlined-deps.reagent.v0v8v1.reagent.debug :refer-macros [dbg prn dev? warn error warn-unless
                                          assert-callable]]))
