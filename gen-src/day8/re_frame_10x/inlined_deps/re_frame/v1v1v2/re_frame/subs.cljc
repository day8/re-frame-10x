(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.re-frame.v1v1v2.re-frame.subs
 (:require
   [day8.re-frame-10x.inlined-deps.re-frame.v1v1v2.re-frame.db        :refer [app-db]]
   [day8.re-frame-10x.inlined-deps.re-frame.v1v1v2.re-frame.interop   :refer [add-on-dispose! debug-enabled? make-reaction ratom? deref? dispose! reagent-id]]
