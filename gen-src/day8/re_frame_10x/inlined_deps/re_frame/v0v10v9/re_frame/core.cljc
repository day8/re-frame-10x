(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.core
  (:require
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.events           :as events]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.subs             :as subs]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.interop          :as interop]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.db               :as db]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.fx               :as fx]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.cofx             :as cofx]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.router           :as router]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.loggers          :as loggers]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.registrar        :as registrar]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.interceptor      :as interceptor]
    [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.std-interceptors :as std-interceptors :refer [db-handler->interceptor
...
;;   (day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.core/set-loggers!  {:warn my-fn :log my-fn})       ;; override the defaults with mine
...
(defn purge-event-queue
  ...
  []
  (router/purge day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.router/event-queue))
...
(defn add-post-event-callback
  ...
  ([id f]
   (router/add-post-event-callback day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.router/event-queue id f)))


(defn remove-post-event-callback
  [id]
  (router/remove-post-event-callback day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.router/event-queue id))
