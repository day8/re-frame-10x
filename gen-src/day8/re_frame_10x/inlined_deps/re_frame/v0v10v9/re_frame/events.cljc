(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.events
  (:require [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.db          :refer [app-db]]
            [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.utils       :refer [first-in-vector]]
            [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.interop     :refer [empty-queue debug-enabled?]]
            [day8.re-frame-10x.inlined-deps.re-frame.v0v10v9.re-frame.registrar   :refer [get-handler register-handler]]
