(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.re-frame.v0v10v6.re-frame.registrar
  ...
  (:require  [day8.re-frame-10x.inlined-deps.re-frame.v0v10v6.re-frame.interop :refer [debug-enabled?]]
