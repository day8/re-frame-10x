(ns ^{:mranderson/inlined true} day8.re-frame-10x.inlined-deps.re-frame.v0v10v6.re-frame.router
  (:require [day8.re-frame-10x.inlined-deps.re-frame.v0v10v6.re-frame.events  :refer [handle]]
            [day8.re-frame-10x.inlined-deps.re-frame.v0v10v6.re-frame.interop :refer [after-render empty-queue next-tick]]
