(ns mranderson048.garden.v1v3v3.garden.def
  (:require [mranderson048.garden.v1v3v3.garden.types]
            [mranderson048.garden.v1v3v3.garden.util :as util]
            [mranderson048.garden.v1v3v3.garden.core])
...
(defmacro defstylesheet
  ...
  [name & styles]
  `(def ~name (mranderson048.garden.v1v3v3.garden.core/css ~@styles)))
